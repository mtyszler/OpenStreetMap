    ...
    if element.tag == 'node':
        ...
        for content in element.iter():
            ...
            if content.tag == "tag":
                ...
                # check for ":"
                if content.attrib["k"].find(":") >= 0:
                    potential_key = content.attrib["k"][content.attrib["k"].find(":") + 1:]
                    potential_type = content.attrib["k"][:content.attrib["k"].find(":")]
                else:
                    potential_key = content.attrib["k"]
                    potential_type = "regular"
                ...
                if PROBLEMCHARS.search(potential_key) == None:
                    ...
                    temp['value'] = content.attrib['v']
                    temp['type'] = potential_type
        ...
        for content in element.iter():
            ...
            if content.tag == "tag":
                ...
                temp['id'] = element.attrib['id']
                temp['node_id'] = content.attrib["ref"]
                temp['position'] = position_count
